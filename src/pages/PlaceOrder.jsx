...
const PlaceOrder = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] bordet-t'>
      {/* Left Side */}
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        <div className='text-xl sm:text-2xl my-3'>
          <Titles text1={'DELIVERY'} text2={'INFOMATION'}/>
        </div>
        ...
        <div className='flex gap-3'>
          <input className='border border-gray-300 rounded py-1.5 px3.5 w-full' type="number" placeholder='Zipcode' />
          <input className='border border-gray-300 rounded py-1.5 px3.5 w-full' type="text" placeholder='Country' />
        </div>
        <input className='border border-gray-300 rounded py-1.5 px3.5 w-full' type="text" placeholder='Phone' />
      </div>
      {/* Right Side */}
      <div className='mt-8'>
